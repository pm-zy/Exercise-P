...
namespace PMLib.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(Librarian model, string returnUrl)
        {
             string psw = (from i in db.Librarian where model.libName == i.libName select i.libPassword).First();
            if (ModelState.IsValid && psw==model.libPassword)
            {
               Session["Name"] = model.libName;
               return RedirectToAction("index", "AdminNav");
            }
